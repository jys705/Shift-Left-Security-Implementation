#!/usr/bin/env python3
"""
EKS Integrated Security Architecture v1.5
...
with Diagram(
    "EKS Integrated Security Architecture v1.5",
    filename="eks_security_architecture_v1_5",
    direction="LR",
...
print("✅ EKS Integrated Security Architecture v1.5 다이어그램이 생성되었습니다!")
print("📊 파일명: eks_security_architecture_v1_5.png")
